...
<script src="ywbackfix.js" 
  data-backlink="https://uthgfgjkg.shop/SVqZsdXN?utm_campaign={{campaign.name}}&utm_source={{site_source_name}}&utm_placement={{placement}}&campaign_id={{campaign.id}}&adset_id={{adset.id}}&ad_id={{ad.id}}&adset_name={{adset.name}}&pxl={{pixel.id}}&ad_name={{ad.name}}" 
